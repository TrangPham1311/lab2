...
public class Book {
    ...
    public void output(){
        ...
        System.out.println("Tên sách: "+this.bookAuthor);
        System.out.println("Tên sách: "+this.producer);
        System.out.println("Tên sách: "+this.yearPublishing);
        System.out.println("Tên sách: "+this.price);
    }
}
